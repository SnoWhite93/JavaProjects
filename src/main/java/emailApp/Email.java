...
public class Email {
    ...
    private String companySuffix = "bixcompany.com";
...
//        this reffers to the class level variable, the var name after = is the local variable
...
//         combine elements to generate email
    ...
    private String randomPassword(int length) {
        ...
        return new String(password); //transforms chars in string
    }
